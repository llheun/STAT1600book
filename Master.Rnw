...
<<Ch14, child="chapters/Workshops/Workshops.Rnw",eval=FALSE>>=
@

<<Ch15, child="chapters/Workshops/Workshops.Rnw",eval=FALSE>>=
@

<<Ch16, child="chapters/Appendix/Appendix.Rnw",eval=FALSE>>=
@
