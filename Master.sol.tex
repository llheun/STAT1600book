...
\begin{exsol@solution}{2.8-11}
    birth weight.
\end{exsol@solution}
\setcounter{chapter}{2}\chapter{Location and Spread}
...
\begin{exsol@solution}{15.7-9}
       ...
       The correlation coefficient between the respondent's height and income is 0.0294914
...
\begin{exsol@solution}{15.7-11}
    ...
    For a sample of 40 subjects, we tested the relationship between height and income.  We found a weak positive relationship using the correlation coefficient (0.1717307).  We then looked at the slope:  as {\textit{height}} increases by one inch, {\textit{income}} increases by 0.2395998 with a p-value of
