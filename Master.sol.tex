...
\end{exsol@solution}
\setcounter{chapter}{9}\chapter{Sampling Distribution of the Mean}
...
\end{exsol@solution}
\setcounter{chapter}{10}\chapter{Comparing Two Means}
...
\end{exsol@solution}
\setcounter{chapter}{11}\chapter{Categorical Variables: Association or Independence}
...
\end{exsol@solution}
\setcounter{chapter}{12}\chapter{Correlation}
...
\end{exsol@solution}
\setcounter{chapter}{13}\chapter{Linear Regression}
...
\begin{exsol@solution}{14.7-9}
       ...
       The correlation coefficient between the respondent's height and income is 0.118635
...
\begin{exsol@solution}{14.7-11}
    ...
    For a sample of 40 subjects, we tested the relationship between height and income.  We found a weak positive relationship using the correlation coefficient (0.3444344).  We then looked at the slope:  as {\textit{height}} increases by one inch, {\textit{income}} increases by 0.5400534 with a p-value of
...
\end{exsol@solution}
\setcounter{chapter}{14}\chapter{Workshops}
