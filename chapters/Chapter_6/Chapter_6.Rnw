...
<<label=LBL4a, results="asis", echo=FALSE, out.width="14cm", out.height="8cm" >>=
...
<<label=LBL4b, results="asis", echo=FALSE, out.width="10cm", out.height="10cm" >>=
  xv <- seq(-4, 4, by=.01)
...
<<label=LBL4c1, results="asis", echo=FALSE, out.width="7cm", out.height="7cm">>=
  xr <- seq(-3, 3, by=0.01)
...
\end{minipage}
\begin{minipage}[ht]{7cm}
<<label=LBL4c2, results="asis", echo=FALSE, out.width="7cm", out.height="7cm">>=
  xs <- seq(-3, 3, by=0.01)
...
%<<label=LBL4d1, results="asis", echo=FALSE, out.width="7cm", out.height="7cm">>=
<<label=LBL4d, results="asis", echo=FALSE, out.width="7cm", out.height="7cm" >>=
  xr <- seq(-3, 3, by=0.01)
  yr <- dnorm(xr, mean=0, sd=1)
  x_coor  <- seq(from=-3, to=3, by=1)
  x_coor <-c(x_coor,0.5)
...
%\end{minipage}
%\begin{minipage}[ht]{7cm}
%<<label=LBL4d2, results="asis", echo=FALSE, out.width="7cm", out.height="7cm">>=
%  xu <- seq(-4, 4, by=0.01)
...
<<label=LBL4e, results="asis", echo=FALSE, out.width="8cm" >>=
  ...
  p<-ggplot(df1,aes(x=xr, y=yr))+geom_line() + 
     ...
     annotate(geom = "text", x=x_coor, y=-0.07*yrng, label="|", size=3) +
     annotate(geom = "text", x=x_coor, y=-0.23*yrng, label="|", size=3) +
     annotate("text",x=2.5,y=0.15, label="10%", color="black", size=5) + 
