...
A psychologist wants to know the following: Can certain optical illusions fool adults with normal vision?  She randomly selected 50 students from her PSY 120 class and found that the illusion fooled 42 of them.  The population in this study is
...
%       \end{enumerate}
    ...
    \end{exercise}
    \begin{solution}
      The population in this study is all adults with normal vision.
    \end{solution}
