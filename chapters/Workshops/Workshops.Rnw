...
\end{table}
    ...
    Using the data from Table 15.1,
...
\end{table}
    ...
    Using the data from Table 15.2,
...
\begin{verbatim}
<<label=LBL15a, results="asis", echo=FALSE>>=
  dt15 <- c(14,16,22,23,25,28,30,34,34,36,37,37,39,41,43,45,49,54,56)
  stem(dt15, scale = 1)
@
\end{verbatim}
...
\begin{enumerate}
  ...
  \item What is the margin of error of your sample proportion at a 95\% confidence level?
  \item What is the confidence interval for the sample proportion at a 95\% confidence level?
...
\begin{tabular}{@{} lccc @{}} \hline
& \multicolumn{2}{c}{Death from CHD} \\ \hline 	 		 
