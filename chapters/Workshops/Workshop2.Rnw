...
\begin{enumerate}
  ...
  \item	Calculate the Standard Error for your estimate in (a), use a standard deviation of 5.718.
...
\begin{enumerate}
  ...
  \item Which set of two variables exhibits the strongest relationship: Monthly Payment \& No. of Bedrooms, or Monthly Payment \& 12-month HH Income? Why?
\end{enumerate}
