...
{\small{
Table 15.1: A partial list of students registered for Stat 1600 during Fall 2016 of their Major course of study.
...
{\small{
Table 15.2: A partial list of students registered for Stat 1600 during Fall 2016 of their Major course of study.
...
% 14,16,22,23,25,28,30,34,34,36,37,37,39,41,43,45,49,54,56

\begin{verbatim}
<<label=LBL15a, results="asis", echo=FALSE>>=
  DT1 <- c(14,16,22,23,25,28,30,34,34,36,37,37,39,41,43,45,49,54,56)
  stem(DT1, scale=1)
@
\end{verbatim}
...
According to an October 27, 2006 article in \textit{Newsweek}, 60\% of Americans said that they take expired medicines. Suppose that this result is true of the current population of Americans. 
