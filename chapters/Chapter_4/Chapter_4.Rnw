...
\fbox{\parbox{14cm}{
 ...
 \begin{enumerate}
 \item Understand the difference between association and cause.
 \item How confounders can affect the results of a survey.
 	\end{enumerate}
 }}
