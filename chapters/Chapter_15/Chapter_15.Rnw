...
<<label=LBL15a, results="asis", echo=FALSE, out.width="9cm", out.height="9cm">>=
budget1 <- c(50.1,74.1,19.3,22.9,82.4,40.1,185.9,26.9,20.4,166.2,27.0,
             45.6,154.9,5.0,49.7,26.9,5.7,7.6,9.2,32.4,6.1)
impress1 <- c(32.1,99.6,11.7,21.9,60.8,78.6,92.4,50.7,21.4,40.1,40.8,
              10.4,88.9,12.0,29.2,38.0,10.0,12.3,23.4,71.1,4.4)
df2 <- data.frame(budget1,impress1)
p <- ggplot(df2, aes(x=budget1, y=impress1)) + geom_point(size=2, shape=23) + theme_bw() +
      labs(x="Ad Spending", y="Impressions")
p
@
...
<<label=LBL15b1, results="asis", echo=FALSE, out.width = "7cm", out.height="7cm">>=
...
Correlation plots (from top to bottom, r = \Sexpr{cr1}, \Sexpr{cr2} )

% \caption{Correlation plots (from top to bottom, r = \Sexpr{cr1}, \Sexpr{cr2} )}

<<label=LBL15b, results="asis", echo=FALSE, out.width="39mm", out.height="39mm">>=
  plot(wt1, mpg1, xlab="Car weight", ylab="MPG")
@
<<label=LBL15c, results="asis", echo=FALSE, out.width="39mm", out.height="39mm">>=
...
Correlation plots (from top to bottom, r = \Sexpr{cr3}, \Sexpr{cr4})

% \caption{Correlation plots (from top to bottom, r = \Sexpr{cr3}, \Sexpr{cr4})}

<<label=LBL15d, results="asis", echo=FALSE, out.width="4cm", out.height="4cm">>=
  plot(temp1, use1, xlab="Ave-Temp", ylab="Power Usage (KW)")
@  
<<label=LBL15e, results="asis", echo=FALSE, out.width="4cm", out.height="4cm">>=
...
\end{exercise}
\begin{solution}  % 1
<<label=lbl15-1, results='asis', echo=FALSE>>=
  X1 <- c(-2, 2, 5, -1, 6)
  Y1 <- c(0 , 3, 10, 1, 15)
