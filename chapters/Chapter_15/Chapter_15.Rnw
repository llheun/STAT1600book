...
<<label=LBL15a, results="asis", echo=FALSE, out.width="10cm", out.height="6cm">>=
...
<<label=LBL15b1, results="asis", echo=FALSE>>=
...
<<label=LBL15b, results="asis", echo=FALSE, out.width="4cm", out.height="4cm">>=
  plot(wt1, mpg1, xlab="Car weight", ylab="MPG")
@
<<label=LBL15c, results="asis", echo=FALSE, out.width="4cm", out.height="4cm">>=
