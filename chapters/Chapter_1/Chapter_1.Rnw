...
Most science journals, after 1966, started to report the results of statistical studies.  For example, FDA (Food and Drug Agency) approved many drugs with written statements from a physician saying the drug was safe, after 1966 the FDA required statistical studies to show that the proposed drug did not harm.  Later, FDA expected that the drug would be therapeutic.
...
Critical thinking starts with asking these type of questions: How can I confirm the validity of these data?  What can I infer from these data?  Is the source of these data credible?  Etc.
