...
\begin{enumerate}
  ...
  \item	If a child has a negative residual, then do they fall above or below the predicted number of words known for average children their age (above of below the regression line)?
