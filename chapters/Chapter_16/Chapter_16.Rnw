...
<<label=LBL16a, results="asis", echo=FALSE, out.width="7cm", out.height="7cm">>=
...
<<label=LBL16b, results="asis", echo=FALSE, out.width="7cm", out.height="7cm" >>=
  tmp1 <- lm(prc1 ~ ml1)
  plot(ml1, prc1, xlab="Miles", ylab="Price ($)")
  abline(tmp1)
...
<<label=LBL16f, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.5, fig.height=3.5, fig.cap="No. Beers vs. BAC", out.width="7cm" >>=
