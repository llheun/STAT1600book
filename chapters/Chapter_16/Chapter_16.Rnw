...
<<label=LBL16a, results="asis", echo=FALSE, out.width="8cm", out.height="8cm">>=
  ...
  tmp2 <- plot(ml1, prc1, xlab="Miles", ylab="Price", main="Scatterplot of Price  vs. Miles")
  tmp2
...
<<label=LBL16b, results="asis", echo=FALSE, out.width="8cm", out.height="8cm" >>=
  tmp1 <- lm(prc1 ~ ml1)
...
<<label=LBL16c, results="asis", echo=FALSE>>=
  rs1 <- numeric(12)
  yh1 <- numeric(12)
...
<<label=LBL16f, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.5, fig.height=3.5,  out.width="7cm" >>=
      ### fig.cap="No. Beers vs. BAC",
...
<<label=LBL16h, results="asis", echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.5, fig.height=3.5, fig.cap="Respondent's Height vs. Income", out.width="7cm" >>=
...
{\tiny{
  \begin{verbatim}
  <<label=LBL16j, results="asis", echo=FALSE>>=
  print(summary(m12))
@
  \end{verbatim}
}}
...
{\small{
<<label=LBL16i, results="asis", echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.5, fig.height=3.5, fig.cap="Respondent's Height vs. Income", out.width="7cm" >>=
...
{\tiny{
  \begin{verbatim}
  <<label=LBL16k, results="asis", echo=FALSE>>=
  print(summary(m13))
@
  \end{verbatim}
}}
...
{\small{
<<label=LBL16e, results="asis", echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.5, fig.height=3.5, fig.cap="Respondent's Height vs. Income", out.width="7cm" >>=
...
{\tiny{
  \begin{verbatim}
  <<label=LBL16l, results="asis", echo=FALSE>>=
  print(summary(m14))
@
  \end{verbatim}
}}
