...
<<label=LBL2b, results="asis", echo=FALSE, out.height="6cm">>=
  barplot(v2, main="Bar Plot for Type of Payment", xlab="Type of Monthly Payment", ylab="Relative Frequency", col="green", ylim=c(0,60))
@
...
<<label=LBL2c, results="asis", echo=FALSE, out.width="8cm">>=
  pie(v2, main="Pie Chart for Type of Payment")
@
...
<<label=LBL2g, results="asis", echo=FALSE, out.height="7cm">>=
   hist(Monthly.Payment, xlab="Monthly Payments", main="Histogram of Monthly Payments", col="green")
@
...
<<label=LBL2h, results="asis", echo=FALSE, out.height="8cm", out.width="12cm">>=
...
<<label=LBL2i, results="asis", echo=FALSE, out.width='8cm'>>=
  boxplot(MP3, horizontal=TRUE, xlab="Dollars", main="Boxplot of Monthly Payments", col="green", range=0)
@
...
<<label=LBL2j, results="asis", echo=FALSE, out.width="9cm">>=
  boxplot(Monthly.Payment ~ Type.of.Payment, horizontal=TRUE, xlab="Dollars", main="Boxplot of Monthly Payments", ylab="Type", col="green", range=0)
@
...
<<label=LBL2m, results="asis", echo=FALSE>>=
...
<<label=LBL2o, resutls="asis", echo=FALSE, out.width="6cm">>=
  hist( rbeta(10000,5,5),  col="skyblue", main="Symmetric", xlab="" )    ## symmetric
       
  hist( rbeta(10000, 2, 5),  col="skyblue", main="Right Skewed", xlab="" )     ## right skewed
  
  hist(rbeta(10000, 5, 2),  col="skyblue", main="Left Skewed", xlab="" )    ## left skewed  
@  
