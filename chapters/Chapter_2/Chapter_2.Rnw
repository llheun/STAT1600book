...
Ratio variables are numerical variables with true zero.  Many credit hours is a ratio measurement.  A student who has completed 90 credit hours has twice as many as 45 credit hours and three times as many as 30 credit hours.  Another example is the speed of an automobile which has true zero mph when it is not moving.  A speed of 40 mph is twice as fast as 20 mph.
...
<<label=LBL2g, results="asis", echo=FALSE, out.width="10cm">>=
...
<<label=LBL2h, results="asis", echo=FALSE, out.width='8cm'>>=
  boxplot(MP3, horizontal=TRUE, xlab="Dollars", main="Box of Monthly Payments", col="green")
@
...
<<label=LBL2m, results="asis", echo=FALSE, out.width="4cm">>=
  ...
  hist(SDat4, xlab="values", col="green")
@
