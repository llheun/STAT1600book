...
\fbox{\parbox{14cm}{
\begin{itemize}
  \item Classify variables.
  \item Understand the difference between dependent and independent variables.
  \item Summarize data using graphical methods.
  \item Describe data in tabular form.
  \item Compute relative frequencies.
  % \item Use procedures to display data graphically.
...
% \begin{minipage}[ht]{5cm}
% 
% <<label=LBL2m, results="asis", echo=FALSE, out.width="5cm">>=
%   hist(SDat1, xlab="values", main="Symmetric")
% @
% \end{minipage}
% \begin{minipage}[ht]{5cm}
% 
% <<label=LBL2n, results="asis", echo=FALSE, out.width="5cm">>=
%   hist(SDat2, xlab="values", main="Right-Skewed")
% @
% \end{minipage}
% \begin{minipage}[ht]{5cm}
% 
% <<label=LBL2o, results="asis", echo=FALSE, out.width="5cm">>=
%   hist(SDat3, xlab="values", main="Left-Skewed")
% @
% \end{minipage}
